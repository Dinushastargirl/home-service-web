    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="hero-title text-6xl md:text-8xl lg:text-[10rem] mb-8 leading-[0.85] tracking-tighter">
            <span className="block">Hi, I'm</span>
            <span className="block text-primary">Dinusha</span>
          </h1>
          
          <p className="hero-sub text-xl md:text-3xl text-foreground/60 font-medium max-w-2xl mx-auto mb-12 leading-tight">
